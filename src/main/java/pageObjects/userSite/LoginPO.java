...
public class LoginPO extends BaseAction {
    ...
    public void inputUsername() {
        ...
        senkeyToElement(driver, LoginPUI.USER_NAME_TEXTBOX, GlobalConstants.DEV_USER_USERNAME);
    }

    public void inputPassword() {
        waitForElementVisible(driver, LoginPUI.PASSWORD_TEXTBOX);
        senkeyToElement(driver, LoginPUI.PASSWORD_TEXTBOX, GlobalConstants.DEV_USER_PASSWORD);
    }
